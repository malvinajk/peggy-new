...
## Demo
<img alt="Screenshot of interactive portfolio" src="https://github.com/user-attachments/assets/14ed84e3-b09d-4d9e-8aaf-7454e227cb14" width="80%" />

<img src="https://github.com/user-attachments/assets/5d72ed43-d564-4606-b17b-9bc4df9010f2" width="80%" />
...
- Move media to external hosting (Cloudinary);
- Lightbox with prev/next cycling through all images;
- Keyboard and swipe navigation for lightbox;
- Separate exhibition section;
- Event delegation for media click listeners;
